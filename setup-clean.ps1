# SmartBox Next - Clean Setup Script (ohne Emojis)
...
Write-Host "`nInitializing Wails project..." -ForegroundColor Green
...
# Schritt 5: Go mod initialisieren
Write-Host "`nInitializing Go module..." -ForegroundColor Green
go mod init smartbox-next
go mod tidy

# Schritt 6: Go Dependencies installieren
Write-Host "`nInstalling Go dependencies..." -ForegroundColor Green
